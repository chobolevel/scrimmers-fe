...
import { TeamLeaveRequest } from '@/apis/team/leave'

interface TeamLeaveRequestListItemProps {
  request: TeamLeaveRequest
}

const TeamLeaveRequestListItem = ({
  request,
}: TeamLeaveRequestListItemProps) => {
  const invalidate = useInvalidate(toUrl(ApiV1Paths.TEAM_LEAVE_REQUESTS))
...
export default TeamLeaveRequestListItem
